          ...
          <div className="space-y-1">
            ...
            <Link href="/carriers">
              <a
                className={cn(
                  "sidebar-item",
                  isActive("/carriers") || location.startsWith("/carriers/")
                    ? "sidebar-item-active"
                    : "text-gray-700"
                )}
        ...
        <div className="pt-6">
          ...
          <div className="space-y-1">
            ...
            <div className="pt-4 border-t border-gray-200 mt-4">
              <h4 className="px-3 text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">
                Access Management
              </h4>
              <div className="space-y-1">
                <Link href="/access-management">
                  <a
                    ...
                    data-testid="link-access-management"
                  >
                ...
                <Link href="/role-management">
                  <a
                    ...
                    data-testid="link-role-management"
                  >
                    <FaCogs className="h-5 w-5 text-orange-600" />
                ...
                <Link href="/permission-management">
                  <a
                    className={cn(
                      "sidebar-item",
                      isActive("/permission-management")
                        ? "sidebar-item-active"
                        : "text-gray-700"
                    )}
                    data-testid="link-permission-management"
                  >
                    <FaDatabase className="h-5 w-5 text-green-600" />
