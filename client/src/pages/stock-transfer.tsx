...
export default function StockTransferPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_: any, transfer: any) => {
        ...
        return (
          <div className="flex items-center gap-2">
            <Link href={`/stock-transfer/${transfer.id || transfer.referenceId}`}>
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
                                ...
                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                  <FormControl>
                                    <SelectTrigger className="bg-white border-slate-300 focus:border-purple-500 focus:ring-purple-500">
                                      <SelectValue placeholder="Select customer" className="text-slate-500" />
                                    </SelectTrigger>
                                  </FormControl>
                                  <SelectContent>
                                    {customersLoading ? (
                                      <div className="px-4 py-2 text-gray-500 text-sm">Loading customers...</div>
                                    ) : customersData && Array.isArray(customersData) && customersData.length === 0 ? (
                                      <div className="px-4 py-2 text-gray-500 text-sm">No customers available</div>
      ...
      {/* Transfer Details moved to dedicated page at /stock-transfer/:id */}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="font-semibold text-slate-700">Requested By</FormLabel>
                        <Select onValueChange={field.onChange} defaultValue={field.value || selectedTransfer.requestedBy || selectedTransfer.createdBy || ""}>
                          <FormControl>
                            <SelectTrigger className="bg-white border-slate-300 focus:border-purple-500 focus:ring-purple-500">
                              <SelectValue placeholder="Select customer" className="text-slate-500" />
                            </SelectTrigger>
