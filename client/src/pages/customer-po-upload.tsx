...
import { Upload, Search, Filter, FileText, Check, AlertTriangle, X, Clock, FileUp, CheckCircle, ShoppingBag, Eye } from "lucide-react";
            ...
            {quotation.customerPoDocument && (
              <Button
                ...
                onClick={(e) => {
                  ...
                  let documentUrl = quotation.customerPoDocument;
                  ...
                  if (documentUrl.startsWith('http')) {
                    // Full URL - use as is
                    console.log('Using full HTTP URL:', documentUrl);
                  } else if (documentUrl.startsWith('/api/files/')) {
                    // Already has the correct path - convert download to view
                    if (documentUrl.includes('/download/')) {
                      documentUrl = documentUrl.replace('/download/', '/view/');
                    }
                    console.log('Using existing API path:', documentUrl);
                  } else {
                    // Just the filename - add the view path for inline viewing
                    documentUrl = `/api/files/view/${documentUrl}`;
                    console.log('Using filename with view path:', documentUrl);
                  }
                  
                  console.log('Final document URL:', documentUrl);
                  window.open(documentUrl, '_blank');
                }}
                data-testid={`button-view-document-${quotation.id}`}
