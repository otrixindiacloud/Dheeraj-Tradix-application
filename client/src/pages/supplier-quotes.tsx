  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_: string, quote: any) => {
        ...
        // Prefer customer object, then API-provided customerName, then parse notes
    ...
    },
    {
      ...
      render: (_: string, quote: any) => {
        if (quote.requisitionNumber) {
          return (
            <div className="flex items-center gap-2">
              <FileText className="h-4 w-4 text-green-600" />
              <span className="font-medium text-gray-900">{quote.requisitionNumber}</span>
            </div>
          );
        }
        return (
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-400">No Requisition</span>
          </div>
        );
      },
    },
        ...
        if (quote.enquiryNumber) {
          return (
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium text-gray-900">{quote.enquiryNumber}</span>
            </div>
          );
        }
