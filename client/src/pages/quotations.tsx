...
export default function QuotationsPage() {
  ...
  const [downloadingQuotation, setDownloadingQuotation] = useState<string | null>(null);
  ...
  const handleDownload = async (quotation: Quotation) => {
    try {
      // Show loading state
      setDownloadingQuotation(quotation.id);
      
      // Call the PDF API endpoint directly
          ...
          {user?.username === "client" ? (
            ...
            <>
              ...
              <Button
                ...
                disabled={downloadingQuotation === quotation.id}
                data-testid={`button-download-${quotation.id}`}
              >
                {downloadingQuotation === quotation.id ? (
          ...
          {error ? (
            ...
            <>
              <DataTable
                ...
                className="ml-6 border-gray-100 shadow-none"
