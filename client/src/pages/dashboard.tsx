...
import { PROCESS_FLOW_STEPS } from "@/lib/process-flow-constants";
import { Download, Plus, TrendingUp, TrendingDown, Eye, CheckCircle, HelpCircle, FileText, ShoppingCart, CreditCard, CheckCircle2, Upload, Package, BarChart3, Clock } from "lucide-react";
import { 
  FaDownload, 
  FaPlus, 
  FaEye, 
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        {(() => {
          ...
          // Step 5: Sales Order exists
          if (sortedOrders.length > 0) {
            completedSteps.push(5);
            currentStep = 6;
          }

          // Step 6: Delivery Note Management
          // This step is considered complete if we have delivery notes or shipments
          if (sortedShipments.length > 0) {
            completedSteps.push(6);
            currentStep = 7;
          }

          // Step 7: Invoicing Management
          // This step is considered complete if we have invoices
          // For now, we'll assume it's complete if we have sales orders (indicating invoicing is ready)
          if (sortedOrders.length > 0) {
          ...
          // Step 9: Requisition Management
          if (sortedSupplierQuotes.length > 0) {
            completedSteps.push(9);
            currentStep = 10;
          }

          // Step 10: Supplier Quotes Management
          if (sortedSupplierQuotes.length > 0) {
            completedSteps.push(10);
            currentStep = 11;
          }

          // Step 11: Supplier LPO Management
          ...
          if (sortedShipments.length > 0) {
            ...
            currentStep = 12; // This is the final step
          }
          ...
          const maxStepId = PROCESS_FLOW_STEPS?.[PROCESS_FLOW_STEPS.length - 1]?.id || 12; // fallback to last known id
