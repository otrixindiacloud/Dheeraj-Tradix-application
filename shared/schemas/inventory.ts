...
export const stockMovements = pgTable("stock_movements", {
  ...
  transferNumber: text("transfer_number"), // For transfer-specific tracking
  storageLocation: text("storage_location"),
  fromLocation: text("from_location"), // For transfers
  toLocation: text("to_location"), // For transfers
  transferDate: timestamp("transfer_date"), // For transfers
  requestedBy: text("requested_by"), // For transfers
  reason: text("reason"), // For transfers
